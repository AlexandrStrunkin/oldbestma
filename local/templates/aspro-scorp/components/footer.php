						...
						<div class="col-md-9 col-sm-12">
							<div class="row">
								...
								<div class="col-md-3 col-sm-3">
									...
									<div class="social">
										<?$APPLICATION->IncludeComponent("aspro:social.info.scorp", "", array(
											"VK" => $arTheme["SOCIAL_VK"]["VALUE"],
											"FACEBOOK" => $arTheme["SOCIAL_FACEBOOK"]["VALUE"],
											"TWITTER" => $arTheme["SOCIAL_TWITTER"]["VALUE"],
											"YOUTUBE" => $arTheme["SOCIAL_YOUTUBE"]["VALUE"],
											"CACHE_TYPE" => "A",
											"CACHE_TIME" => "3600000",
											"CACHE_GROUPS" => "N"
											),
