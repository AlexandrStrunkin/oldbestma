            ...
            <tr id="<?= $this->GetEditAreaId($arElement['ID']); ?>" class="prod_parent_block_8dfd71c72ba4339630bf25e7445cf49a">
                ...
                <td class="first">
                    <? if (is_array($arElement["PREVIEW_PICTURE"])): ?>
                        <div class="w_zoom_img"><a href="<?= $arElement["DETAIL_PAGE_URL"] ?>"><img class="class_img_item_0620e44395b9ad45e489d15b3615c972" src="<?=$arFileTmp["src"] /*$arElement["PREVIEW_PICTURE"]["SRC"]*/ ?>" alt="<?= $arElement["NAME"] ?>"/></a></div>
                    <? elseif (is_array($arElement["DETAIL_PICTURE"])): ?>
                        <div class="w_zoom_img"><a href="<?= $arElement["DETAIL_PAGE_URL"] ?>"><img class="class_img_item_0620e44395b9ad45e489d15b3615c972" src="<?= $arFileTmp["src"] /*$arElement["DETAIL_PICTURE"]["SRC"]*/ ?>" alt="<?= $arElement["NAME"] ?>"/></a></div>
                    <? endif ?>
