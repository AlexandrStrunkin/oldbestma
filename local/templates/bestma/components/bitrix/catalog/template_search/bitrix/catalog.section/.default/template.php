...
<!--<h1 class="name"><? //$APPLICATION->ShowTitle() ?></h1>-->
    ...
    <ul>
        ...
        <li>
            ...
            <ul>
                ...
                <li class="tile">
                    <a href="<?= $APPLICATION->GetCurPageParam("view=" . "tile", array("view")); ?>">картинками</a>
                </li>
            </ul>
        </li>
    </ul>
...
<table class="items_list">
    ...
    <tr>
        ...
        <?endforeach;?>
<!--        --><?//print_r($section_id_new);?>

    </tr>
    <tbody>

    <?global $section_id_new;?>
    <?$first_time=true;?>
        <? foreach ($arResult["ITEMS"] as $cell => $arElement): ?>
            <?
            ...
            ?>
                        ...
                        <th>
            <?/*В первый раз мы запонимаем текущий ID и потом с ним будем сравнивать*/?>
            <?if($first_time):?>
                <?$section_id_new=$arElement['IBLOCK_SECTION_ID'];?>
                <?$first_time=false;?>
                <?$section_object = CIBlockSection::GetByID($arElement['IBLOCK_SECTION_ID']);?>
                <?$section_block = $section_object->Fetch();?>
                <div class="section_block_container">
                    <div class="section_block_radio_btn"><img src="/bitrix/templates/bestma/images/labeling.png"></div>
                    <div class="section_block_name"> <?print_r($section_block["NAME"]);?></div>
                    <div class="section_block_right_size">&nbsp</div>
                </div>
            <?endif;?>
            <?//Если текущий Id не равен запомненному, присваиваем $section_id_new новое значение и выводим имя раздела?>

            <?if($section_id_new!==$arElement['IBLOCK_SECTION_ID']):?>
                <?$section_id_new=$arElement['IBLOCK_SECTION_ID'];?>
                <?$section_object = CIBlockSection::GetByID($arElement['IBLOCK_SECTION_ID']);?>
                <?$section_block = $section_object->Fetch();?>
                <div class="section_block_container">
            ...
            <tr id="<?= $this->GetEditAreaId($arElement['ID']); ?>" class="prod_parent_block_8dfd71c72ba4339630bf25e7445cf49a">
                <td class="margin-left"><!--<?print_r($arElement);?>--></td>
                <td class="first">
                ...
                <td class="name">
                    ...
                    <br /><span class="article">арт. <?= $arElement["DISPLAY_PROPERTIES"]["CML2_ARTICLE"]["DISPLAY_VALUE"]; ?></span>
                </td>
