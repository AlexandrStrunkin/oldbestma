...
//        $sort = $arAvailableSort[($_REQUEST["sort"])][0];
//        $_SESSION["sort"] = ($_REQUEST["sort"]);
//        $_SESSION["sortOrder"] = $sortOrder = $arAvailableSort[($_REQUEST["sort"])][1];
//    }
//    //берем из сессии
//} elseif (isset($_SESSION["sort"]) && array_key_exists(($_SESSION["sort"]), $arAvailableSort)) {
//    $sort = $arAvailableSort[($_SESSION["sort"])][0];
...
//выбиралка шаблона
//if (array_key_exists("view", $_REQUEST) && array_key_exists(($_REQUEST["view"]), $arViewPage)) {
//    $view = $arViewPage[($_REQUEST["view"])];
//} elseif (isset($_SESSION["view"]) && array_key_exists(($_SESSION["view"]), $arViewPage)) {
//    $view = $arViewPage[($_SESSION["view"])];
//} else {
//    $view = "";
//}
//$_SESSION["view"] = $view;
...
//    if (isset($filter)) {
//        if ($filter >= 0) {
//            $prFilter["PROPERTY_" . ($stringNameKey)] = $filter;
//        }
//    }
//}
