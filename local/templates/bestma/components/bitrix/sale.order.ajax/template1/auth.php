...
<table border="0" cellspacing="0" cellpadding="1" style="display: none;">
	<tr>
	...
	<tr>
		<td valign="top">
			<form method="post" action="" name="order_auth_form">
				...
				?>
				<table class="sale_order_full_table terest">
					<tr>
						<td><?echo GetMessage("STOF_LOGIN_PROMT")?></td>
					</tr>
					<tr>
						<td nowrap><?echo GetMessage("STOF_LOGIN")?> <span class="starrequired">*</span>
							<input type="text" name="USER_LOGIN" maxlength="30" size="30" value="<?=$arResult["AUTH"]["USER_LOGIN"]?>">&nbsp;&nbsp;&nbsp;</td>
					</tr>
					<tr>
						<td nowrap><?echo GetMessage("STOF_PASSWORD")?> <span class="starrequired">*</span>
			...
			<?if($arResult["AUTH"]["new_user_registration"]=="Y"):?>
				<form method="post" action="" name="order_reg_form">
					...
					<table class="sale_order_full_table">
						<tr>
							<td nowrap>
								<?echo GetMessage("STOF_NAME")?> <span class="starrequired">*</span>
								<input type="text" name="NEW_NAME" size="40" value="<?=$arResult["AUTH"]["NEW_NAME"]?>">&nbsp;&nbsp;&nbsp;
							</td>
						</tr>
						<tr>
							<td nowrap>
								<?echo GetMessage("STOF_LASTNAME")?> <span class="starrequired">*</span>
						...
						<?endif;?>
										<tr>
											...
											<td width="0%">&nbsp;&nbsp;&nbsp;</td>
											<?endif;?>
											<td><?echo GetMessage("STOF_LOGIN")?> <span class="starrequired">*</span>
										...
										<tr>
											...
											<?endif;?>
											<td>
												<?echo GetMessage("STOF_PASSWORD")?> <span class="starrequired">*</span>
										...
										<tr>
											...
											<?endif;?>
											<td>
												<?echo GetMessage("STOF_RE_PASSWORD")?> <span class="starrequired">*</span>
