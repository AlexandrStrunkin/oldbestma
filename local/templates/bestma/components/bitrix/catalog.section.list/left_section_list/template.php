                        ...
                        <ul <? if ($trueActive): ?>style="display: block;"<? endif; ?>>
                            ...
                            <? if ($arLevels_0 !== null && is_array($arLevels_0) && (count($arLevels_0) > 0)): ?>
                                <? foreach ($arLevels_0 as $itemLev_0): ?>
                                    ...
                                    <li id="s<?=$arSections["$itemLev_0"]["ID"]?>"><a href="<?= $arSections["$itemLev_0"]["SECTION_PAGE_URL"] ?>" <? if ($temp == $arSections["$itemLev_0"]["ID"]): ?>style="text-decoration: underline;"<? endif; ?>><?= $arSections["$itemLev_0"]["NAME"]; ?></a></li>
                                    <?}?>
                                    <? endforeach; ?>
                                <? endif; ?>
