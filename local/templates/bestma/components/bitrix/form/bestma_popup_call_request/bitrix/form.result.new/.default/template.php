    ...
    ***********************************************************************************/
    ...
    <div class="w_bg_callback">
        ...
        <div class="hidden_shadow">
            <a class="submit_callback" name="web_form_submit" href="#"><span>Заказать обратный звонок</span></a>
        </div>
                            ...
                            <div class="b_fields w_switch hide_input">
                                <ul class="switch"> 
                                    <li class="case active"> 
                                      <div class="phone"> <input checked="checked" type="radio" value="3" name="form_radio_SIMPLE_QUESTION_147" placeholder="Укажите ваш номер телефона" /> </div>
                                     </li>
                                   
                                    <li class="case"> 
                                      <div class="skype"> <input type="radio" value="4" placeholder="Укажите Ваш skype" name="form_radio_SIMPLE_QUESTION_147" /> </div>
                                     </li>
                                   
                                    <li class="case"> 
                                      <div class="icq"> <input type="radio" value="5" placeholder="Укажите номер Вашего icq" name="form_radio_SIMPLE_QUESTION_147" /> </div>
                                     </li>
                                </ul>
                            </div>
                            <div class="b_fields">
...
$(document).ready(function(){
    ...
    $("textarea.numb, textarea.question").attr("placeholder");
    $("textarea.numb").attr("placeholder", "Укажите Ваш номер телефона");
    $("textarea.question").attr("placeholder", "Например: как начать с вами сотрудничать");
})</script>